...
The accessibility figures show label relationships, semantic channels, and focus order as visible states. The runnable descriptor example is \api{AccessibleTextExample}.
\end{examplebox}
