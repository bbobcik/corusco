\chapter{Models, Components, and the Presentation Boundary}
...
\begin{chaptermap}
Core question & Which facts belong in Swing components, which belong in Swing models, and which belong in application-owned presentation models?\\
...
Corusco connection & Core models, typed keys, descriptors, problems, values, commands, and lifecycle scopes make the presentation boundary testable.\\
