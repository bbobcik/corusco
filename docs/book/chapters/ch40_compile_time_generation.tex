...
with debugging a PDF figure that silently used placeholder text.
...
Generated sources are also useful for documentation and examples. The book's
companion examples compile annotated sources through the real processor. The
chapter can then refer to \generationExample{} as an anchor without copying a
long generated class into the text. If a listing needs to show generated
shape, it should show a small excerpt and tell the reader which example
produces the full source. This prevents the book from becoming a second,
stale copy of generated output.

\begin{examplebox}{generation}
\generationExample{} is the navigation anchor for the book's generated
customer example. The annotated records \api{CustomerEdit} and
...
opened. This is especially important for the book examples, because PDF
screenshots should show deliberate text rather than missing-resource markers.
...
of those moments. They also make book listings and documentation easier to
write without long explanations.
