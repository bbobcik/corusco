...
Subscription rowCountSubscription = visibleRows.subscribe(changes ->
        rowCount.setValue(visibleRows.size(), StandardChangeOrigin.MODEL));
...
void afterRefresh() {
    ...
    if (!stillPresent) {
        selectedId.setValue(null, StandardChangeOrigin.MODEL);
    }
}
\end{lstlisting}
...
void loadFailed(Throwable failure) {
    loadProblems.setValue(problemFor(failure), StandardChangeOrigin.SYSTEM);
}
\end{lstlisting}
