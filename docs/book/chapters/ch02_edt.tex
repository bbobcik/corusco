...
\api{BookFigureGenerator} renders Figure~\ref{fig:edt-eventqueue-boundary} from a deterministic Swing panel in \api{BookVisualFigures}. The example exists to keep the diagram under the same FlatLaf and screenshot harness as the rest of the book.
\end{examplebox}
