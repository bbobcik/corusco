...
active.setValue(false, StandardChangeOrigin.USER);
...
final class LegacyCustomerFormAdapter
    ...
    void pullFromComponents() {
        model.name.setRawText(panel.nameField().getText(), StandardChangeOrigin.USER);
        model.creditLimit.setRawText(
                panel.creditLimitField().getText(), StandardChangeOrigin.USER);
        model.active.setValue(
                panel.activeBox().isSelected(), StandardChangeOrigin.USER);
    }
