...
\api{BookVisualFigures} contains the command-surface, focus-traversal, and command-routing figures used in this chapter. The screenshots are produced by \api{BookFigureGenerator} through \screenshotHarnessExample{}, keeping keyboard and command examples tied to executable Swing panels.
\end{examplebox}
