...
dependencies {
    implementation 'cz.auderis.corusco:corusco-core:1.2.0'
    implementation 'cz.auderis.corusco:corusco-glazedlists:1.2.0'
    implementation 'cz.auderis.corusco:corusco-swing:1.2.0'
    implementation 'cz.auderis.corusco:corusco-annotations:1.2.0'
    annotationProcessor 'cz.auderis.corusco:corusco-processor:1.2.0'
}
```
