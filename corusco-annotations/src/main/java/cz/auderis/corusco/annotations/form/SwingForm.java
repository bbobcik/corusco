...
/**
 * Marks a record or abstract class as a Swing form source type.
 *
 ...
 * form-model helpers, validation metadata, resource keys, and view-plan
 * metadata for Swing bindings. The generated form works with the core form
 * model APIs rather than with reflection over the source type at runtime.</p>
 *
 ...
 * used on a supported source type and that the id is non-blank.</p>
 *
